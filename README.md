...
```
https://raw.githubusercontent.com/4n0nymou3/Rayan-Config/C-Sub/refs/heads/main/configs/singbox_configs.json
```
...
4. The configs will be automatically updated every hour in `configs/proxy.txt`.
